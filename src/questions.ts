    ...
    options: [
      {
        ...
        feedback: "Conventional/needs improvement:\n\nThe M&E framework is based on standard, dominant Western models and does not explicitly cite or challenge power structures."
      },
      {
        ...
        feedback: "Developing Equity\n\nThe M&E framework has begun to adopt principles like Cultural Competence and critical inquiry but lacks a foundational shift."
      },
      {
        ...
        feedback: "Highly Equitable/Transformative\n\nThe M&E framework is explicitly rooted in African epistemologies and Afrocentricity, uses a decolonised logic model, and aims to address systemic inequities in development outcomes."
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        feedback: "Conventional/needs improvement:\n\nThe M&E framework focuses on general program outcomes without explicit attention to disaggregated data or impact on marginalised groups."
      },
      {
        text: "Moderate focus",
        level: "L2",
        description: "Tracks some equity indicators such as gender or age.",
        feedback: "Developing Equity:\n\nThe M&E framework tracks outcomes based on basic demographic categories (e.g., gender, age) but lacks an intersectional lens."
      },
      {
        text: "Strong focus",
        level: "L3",
        description: "Uses gender and intersectional approaches to address systemic inequities.",
        feedback: "Highly Equitable/Transformative\n\nThe M&E framework employs a non-negotiable, centred gender and intersectional lens to identify, track, and address systemic and historical inequities."
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        feedback: "Conventional/needs improvement:\n\nThe M&E framework focuses on general programme outcomes without explicit attention to disaggregated data or marginalised groups. Limited attention to intersectional inequities."
      },
      {
        text: "To a limited extent",
        level: "L2",
        description: "Consider some demographic categories such as gender or age.",
        feedback: "Developing Equity:\n\nThe M&E framework tracks outcomes using basic demographic categories (e.g., gender, age). Basic intersectional elements are included but not fully integrated."
      },
      {
        text: "Fully integrated",
        level: "L3",
    ...
    options: [
      {
        ...
        feedback: "Conventional/needs improvement:\n\nThe M&E framework has minimal capacity for equity analysis due to limited data."
      },
      {
        text: "Basic variables",
        level: "L2",
        description: "Data includes basic demographics such as gender and age.",
        feedback: "Developing Equity:\n\nThe M&E framework has some capacity for equity analysis but remains limited in scope. ."
      },
      {
        ...
        feedback: "Highly Equitable / Transformative:\n\nThe M&E framework enables strong equity analysis through robust and disaggregated data systems."
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        feedback: "Conventional/needs improvement:\n\nEvaluation questions are narrowly focused on program efficiency and effectiveness (e.g., \"Did the program work?\")."
      },
      {
        ...
        feedback: "Developing Equity:\n\nEvaluation questions include simple descriptive questions about differential outcomes."
      },
      {
        ...
        feedback: "Highly Equitable/Transformative\n\nEvaluation questions are framed through critical inquiry and power awareness (e.g., \"Whose needs are being served, whose are being ignored, and why?\")."
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        feedback: "Developing Equity:\n\nEvaluation questions include simple descriptive questions about differential outcomes for different groups."
      },
      {
    ...
    options: [
      {
        ...
        feedback: "Conventional/needs improvement:\n\nCommunities and beneficiaries are primarily treated as passive subjects of data collection or as 'informants.'"
      },
      {
        ...
        feedback: "Developing Equity:\n\nCommunities are consulted at specific points (e.g., tool testing) and provide feedback on preliminary findings."
      },
      {
        text: "Co-creators",
        level: "L3",
        ...
        feedback: "Highly Equitable/Transformative\n\nM&E processes are driven by the transformative principle of participation. The community and beneficiaries are recognised as true experts of their own lives and actively co create M&E questions, tools, and timelines, potentially using Empowerment Evaluation."
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        feedback: "Conventional/needs improvement:\n\nMethods are chosen solely for logistical efficiency (e.g., standardised surveys) and ignore local context."
      },
      {
        text: "Partially aligned",
        level: "L2",
        description: "The M&E framework uses some standard methods with limited adaptation to context.",
        feedback: "Developing Equity:\n\nMethods include qualitative techniques but are still selected and designed primarily by external evaluators."
      },
      {
        text: "Ad hoc selection",
        level: "L3",
        description: "The M&E framework selects methods without a clear rationale or consistent approach.",
        feedback: "Highly Equitable/Transformative\n\nMethods prioritise Cultural Competence and the lived realities of participants, utilising approaches like Culturally Responsive Evaluation (CRE) or local, narrative-based methodologies."
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        feedback: "Conventional/needs improvement:\n\nThe NGO/CBO and the donor maintain full control over M&E budget, resource allocation, and timeline."
      },
      {
        ...
        feedback: "Developing Equity:\n\nLimited resources are allocated to compensating community members for their time and contribution to data collection."
      },
      {
        ...
        feedback: "Highly Equitable/Transformative\n\nThe M&E budget includes significant resources dedicated to community capacity-building and decision-making on research methods and data collection protocols (shared ownership)."
      }
    ]
  },
    ...
    options: [
      {
        ...
        feedback: "Conventional/needs improvement:\n\nData is interpreted against universal, pre-defined Western success metrics, potentially leading to cultural misinterpretation."
      },
      {
        ...
        feedback: "Developing Equity:\n\nContextual factors are mentioned as limitations or background, but do not significantly shape the interpretation of findings."
      },
      {
        text: "Not addressed",
        level: "L3",
        description: "The M&E framework does not explicitly consider validity or contextual interpretation.",
        feedback: "Highly Equitable/Transformative\n\nData analysis is grounded in the principle of epistemic humility, where the community is involved in making meaning of the data to ensure interpretations are locally valid and culturally congruent."
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        feedback: "Conventional/needs improvement:\n\nAll raw data is owned by the NGO/CBO or donor, and the community has no automatic right to access or use the data."
      },
      {
        ...
        feedback: "Developing Equity:\n\nThe NGO/CBO shares a final report with the community."
      },
      {
        ...
        feedback: "Highly Equitable/Transformative\n\nData ownership and access protocols are established before M&E begins, ensuring communities have the right to access, utilise, and even veto the sharing of their own data."
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        feedback: "Conventional/needs improvement:\n\nM&E reporting is conducted exclusively in the dominant language of the donor/NGO, without investment in local-language translation."
      },
      {
        text: "Local languages",
        level: "L2",
        description: "The M&E framework translates key findings into local languages.",
        feedback: "Developing Equity:\n\nKey findings summaries are translated into local languages."
      },
      {
        ...
        feedback: "Highly Equitable/Transformative\n\nAll critical M&E documents and feedback loops are proactively produced in locally appropriate languages and formats, recognising diverse literacy levels."
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        feedback: "Conventional/needs improvement:\n\nThe M&E report is circulated primarily to donors and management. Negative findings are often suppressed or softened."
      },
      {
        ...
        feedback: "Developing Equity:\n\nFindings are shared with beneficiaries in an accessible format, but the response to uncomfortable truths is reactive."
      },
      {
        ...
        feedback: "Highly Equitable/Transformative\n\nThe organisation demonstrates courage to challenge donor requirements and report uncomfortable truths. A new tool for accountability is used to clearly link findings on inequity to organisational and policy action"
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        feedback: "Conventional/needs improvement:\n\nFindings lead only to minor operational adjustments within the existing program design."
      },
      {
        ...
        feedback: "Developing Equity:\n\nFindings lead to significant program adjustments but stop short of challenging the NGO/CBO’s own institutional practices or donor policies."
      },
      {
        ...
        feedback: "Highly Equitable/Transformative\n\nFindings are used to actively challenge the root causes of inequity (structural, systemic, and policy barriers) and advocate for change at institutional, policy, and funding levels."
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        feedback: "Conventional/needs improvement:\n\nM&E is treated as a one-off requirement for compliance."
      },
      {
        ...
        feedback: "Developing Equity:\n\nM&E findings are discussed internally, but the learning process is limited to the M&E unit."
      },
      {
        ...
        feedback: "Highly Equitable/Transformative\n\nThe organisation fosters a culture of learning driven by the M&E findings, promoting epistemic humility and integrating learning into all decision-making cycles, ensuring continuous service to equity."
      }
    ]
  }
];
